...
class TestHandleAliExpressAPILinks(unittest.IsolatedAsyncioTestCase):
    ...
    @patch(
        "handlers.aliexpress_api_handler.ALIEXPRESS_DISCOUNT_CODES",
    ...
    async def test_long_aliexpress_link_without_affiliate(
    ...
    async def test_short_aliexpress_link(self, mock_process, mock_convert, mock_expand):
        ...
        mock_expand.assert_called_with(
            "https://s.click.aliexpress.com/e/_someShortLink",
