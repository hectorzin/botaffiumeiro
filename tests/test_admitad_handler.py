...
class TestHandleAdmitadLinks(unittest.IsolatedAsyncioTestCase):
    ...
    @patch(
        "handlers.admitad_handler.ADMITAD_ADVERTISERS", {"pccomponentes.com": "20982"}
    )
    ...
    @patch("handlers.admitad_handler.ADMITAD_ADVERTISERS", {})
    @patch("handlers.base_handler.BaseHandler._process_message")
    ...
    @patch(
        "handlers.admitad_handler.ADMITAD_ADVERTISERS",
    ...
    @patch(
        "handlers.base_handler.ALIEXPRESS_DISCOUNT_CODES", "Here is your discount code!"
    )
    @patch("handlers.admitad_handler.ADMITAD_ADVERTISERS", {"aliexpress.com": "11640"})
    @patch("handlers.admitad_handler.ADMITAD_PUBLISHER_ID", "my_admitad")
    @patch("handlers.base_handler.BaseHandler._process_message")
    ...
    @patch(
        "handlers.admitad_handler.ADMITAD_ADVERTISERS", {"pccomponentes.com": "20982"}
    )  # with elements configured (no Aliexpress)
    @patch("handlers.admitad_handler.ADMITAD_PUBLISHER_ID", "my_admitad")
    @patch("handlers.base_handler.BaseHandler._process_message")
    ...
    @patch(
        "handlers.admitad_handler.ADMITAD_ADVERTISERS", {"pccomponentes.com": "11640"}
    )
    @patch("handlers.admitad_handler.ADMITAD_PUBLISHER_ID", "my_admitad")
    @patch("handlers.base_handler.BaseHandler._process_message")
